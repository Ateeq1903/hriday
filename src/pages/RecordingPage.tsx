...
export function RecordingPage({ onNavigate }: RecordingPageProps) {
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const heartRateData = HealthMonitoringAPI.simulateHeartRateData(recording.id, 60);
      const riskPrediction = HealthMonitoringAPI.simulateRiskPrediction(recording.id, heartRateData);
